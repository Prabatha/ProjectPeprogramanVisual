...
root.geometry('600x260+500+200')
root.config(bg='#223461')
...
def show():
    ...
    show_labelframe=LabelFrame(root,text="          TO DO LIST         ")
    show_labelframe.grid(row=0,column=2,rowspan=2,columnspan=1000)
    default_label=Label(show_labelframe,text="   Id")
